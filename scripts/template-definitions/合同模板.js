...
export const 合同模板 = {
  ...
  '股权转让协议.docx': {
    title: '股权转让协议',
    category: '合同模板',
    description: '股东之间或股东与第三方之间转让股权的协议',
    scene: '股权转让',
    sections: [
      { type: 'paragraph', content: '股权转让协议', indent: false, style: 'center' },
      { type: 'empty' },
      { type: 'paragraph', content: '转让方（甲方）：{{转让方名称}}', indent: false },
      { type: 'paragraph', content: '身份证号/统一社会信用代码：{{转让方证件号}}', indent: false },
      { type: 'paragraph', content: '地址：{{转让方地址}}', indent: false },
      { type: 'paragraph', content: '联系电话：{{转让方电话}}', indent: false },
      { type: 'empty' },
      { type: 'paragraph', content: '受让方（乙方）：{{受让方名称}}', indent: false },
      { type: 'paragraph', content: '身份证号/统一社会信用代码：{{受让方证件号}}', indent: false },
      { type: 'paragraph', content: '地址：{{受让方地址}}', indent: false },
      { type: 'paragraph', content: '联系电话：{{受让方电话}}', indent: false },
      { type: 'empty' },
      {
        type: 'paragraph',
        content: '根据《中华人民共和国公司法》及相关法律法规的规定，甲乙双方在平等、自愿的基础上，就股权转让事宜达成如下协议：'
      },
      { type: 'empty' },
      { type: 'heading', content: '第一条 目标公司' },
      { type: 'paragraph', content: '1. 公司名称：{{公司名称}}' },
      { type: 'paragraph', content: '2. 统一社会信用代码：{{统一社会信用代码}}' },
      { type: 'paragraph', content: '3. 注册地址：{{注册地址}}' },
      { type: 'paragraph', content: '4. 注册资本：人民币{{注册资本}}元' },
      { type: 'empty' },
      { type: 'heading', content: '第二条 转让标的' },
      { type: 'paragraph', content: '1. 甲方将其持有的{{公司名称}}{{持股比例}}%的股权（对应认缴出资{{认缴出资}}元，实缴出资{{实缴出资}}元）转让给乙方。' },
      { type: 'paragraph', content: '2. 转让完成后，甲方不再持有目标公司的股权，乙方持有目标公司{{持股比例}}%的股权。' },
      { type: 'empty' },
      { type: 'heading', content: '第三条 转让价格' },
      { type: 'paragraph', content: '1. 股权转让价格为人民币{{转让价格}}元（大写：{{转让价格大写}}）。' },
      { type: 'paragraph', content: '2. 转让价格包括股权本身的价值以及目标公司截至{{基准日}}的未分配利润、盈余公积等。' },
      { type: 'empty' },
      { type: 'heading', content: '第四条 支付方式' },
      { type: 'paragraph', content: '1. 支付方式：{{支付方式}}' },
      { type: 'paragraph', content: '2. 支付时间：{{支付时间}}' },
      { type: 'paragraph', content: '3. 支付账户：{{支付账户}}' },
      { type: 'paragraph', content: '4. 乙方应在本协议签订后{{支付期限}}日内支付全部转让价款。' },
      { type: 'empty' },
      { type: 'heading', content: '第五条 股权交割' },
      { type: 'paragraph', content: '1. 股权交割日为{{交割日}}。' },
      { type: 'paragraph', content: '2. 甲方应配合乙方办理股权变更登记手续，包括但不限于修改公司章程、变更股东名册、办理工商变更登记等。' },
      { type: 'paragraph', content: '3. 股权变更登记完成后，股权转让即告完成。' },
      { type: 'empty' },
      { type: 'heading', content: '第六条 双方权利义务' },
      { type: 'paragraph', content: '（一）甲方的权利义务：' },
      { type: 'paragraph', content: '1. 甲方保证对转让的股权享有合法的所有权，不存在任何权利瑕疵；' },
      { type: 'paragraph', content: '2. 甲方保证转让的股权未被质押、冻结或设定其他权利负担；' },
      { type: 'paragraph', content: '3. 甲方应配合乙方办理股权变更登记手续；' },
      { type: 'paragraph', content: '4. 甲方有权按照本协议约定收取股权转让价款。' },
      { type: 'paragraph', content: '（二）乙方的权利义务：' },
      { type: 'paragraph', content: '1. 乙方有权按照本协议约定受让股权；' },
      { type: 'paragraph', content: '2. 乙方应按照本协议约定支付股权转让价款；' },
      { type: 'paragraph', content: '3. 乙方应配合甲方办理股权变更登记手续。' },
      { type: 'empty' },
      { type: 'heading', content: '第七条 违约责任' },
      { type: 'paragraph', content: '1. 甲方违反本协议约定，导致股权转让无法完成的，应退还已收取的转让价款，并支付违约金人民币{{违约金金额}}元。' },
      { type: 'paragraph', content: '2. 乙方逾期支付转让价款的，每逾期一日，按应付金额的{{逾期违约金比例}}%（日利率）支付违约金。' },
      { type: 'paragraph', content: '3. 任何一方违反本协议约定的，应赔偿守约方因此遭受的全部损失。' },
      { type: 'empty' },
      ...
      { type: 'paragraph', content: '1. 本协议自双方签字（盖章）之日起生效。' },
      { type: 'paragraph', content: '2. 本协议一式{{份数}}份，甲乙双方各执一份，目标公司留存一份，具有同等法律效力。' },
      { type: 'empty' },
      { type: 'paragraph', content: '甲方（签字/盖章）：{{转让方名称}}', indent: false },
      { type: 'paragraph', content: '乙方（签字/盖章）：{{受让方名称}}', indent: false },
      { type: 'empty' },
      { type: 'paragraph', content: '日期：                            日期：', indent: false }
    ]
  },
  ...
  '服务合同.docx': {
    title: '服务合同',
    category: '合同模板',
    description: '服务提供方与服务接受方签订的服务合同',
    scene: '服务提供',
    sections: [
      { type: 'paragraph', content: '服务合同', indent: false, style: 'center' },
      { type: 'empty' },
      { type: 'paragraph', content: '委托方（甲方）：{{委托方名称}}', indent: false },
      { type: 'paragraph', content: '统一社会信用代码：{{委托方统一社会信用代码}}', indent: false },
      { type: 'paragraph', content: '地址：{{委托方地址}}', indent: false },
      { type: 'paragraph', content: '法定代表人：{{委托方法定代表人}}', indent: false },
      { type: 'paragraph', content: '联系电话：{{委托方电话}}', indent: false },
      { type: 'empty' },
      { type: 'paragraph', content: '服务方（乙方）：{{服务方名称}}', indent: false },
      { type: 'paragraph', content: '统一社会信用代码：{{服务方统一社会信用代码}}', indent: false },
      { type: 'paragraph', content: '地址：{{服务方地址}}', indent: false },
      { type: 'paragraph', content: '法定代表人：{{服务方法定代表人}}', indent: false },
      { type: 'paragraph', content: '联系电话：{{服务方电话}}', indent: false },
      { type: 'empty' },
      {
        type: 'paragraph',
        content: '根据《中华人民共和国民法典》及相关法律法规的规定，甲乙双方在平等、自愿的基础上，就服务事宜达成如下协议：'
      },
      { type: 'empty' },
      { type: 'heading', content: '第一条 服务内容' },
      { type: 'paragraph', content: '1. 服务项目：{{服务项目}}' },
      { type: 'paragraph', content: '2. 服务内容：{{服务内容}}' },
      { type: 'paragraph', content: '3. 服务标准：{{服务标准}}' },
      { type: 'paragraph', content: '4. 服务期限：自{{开始日期}}起至{{结束日期}}止，共计{{期限}}。' },
      { type: 'empty' },
      { type: 'heading', content: '第二条 服务费用' },
      { type: 'paragraph', content: '1. 服务费用总额：人民币{{服务费用总额}}元（大写：{{服务费用总额大写}}）' },
      { type: 'paragraph', content: '2. 支付方式：{{支付方式}}' },
      { type: 'paragraph', content: '3. 支付时间：{{支付时间}}' },
      { type: 'paragraph', content: '4. 支付账户：{{支付账户}}' },
      { type: 'empty' },
      { type: 'heading', content: '第三条 双方权利义务' },
      { type: 'paragraph', content: '（一）甲方的权利义务：' },
      { type: 'paragraph', content: '1. 甲方有权要求乙方按照约定提供服务质量；' },
      { type: 'paragraph', content: '2. 甲方应按照约定支付服务费用；' },
      { type: 'paragraph', content: '3. 甲方应配合乙方提供必要的资料和信息。' },
      { type: 'paragraph', content: '（二）乙方的权利义务：' },
      { type: 'paragraph', content: '1. 乙方应按照约定提供服务质量；' },
      { type: 'paragraph', content: '2. 乙方有权按照约定收取服务费用；' },
      { type: 'paragraph', content: '3. 乙方应保守甲方的商业秘密。' },
      { type: 'empty' },
      { type: 'heading', content: '第四条 违约责任' },
      { type: 'paragraph', content: '1. 乙方未按照约定提供服务的，应承担违约责任，赔偿甲方因此遭受的全部损失。' },
      { type: 'paragraph', content: '2. 甲方逾期支付服务费用的，每逾期一日，按应付金额的{{逾期违约金比例}}%（日利率）支付违约金。' },
      { type: 'paragraph', content: '3. 任何一方违反本协议约定的，应赔偿守约方因此遭受的全部损失。' },
      { type: 'empty' },
      { type: 'heading', content: '第五条 争议解决' },
      {
        type: 'paragraph',
        content: '本协议履行过程中发生争议的，由双方协商解决；协商不成的，依法向{{管辖法院}}人民法院起诉。'
      },
      { type: 'empty' },
      { type: 'heading', content: '第六条 其他约定' },
      { type: 'paragraph', content: '1. 本协议自双方签字（盖章）之日起生效。' },
      { type: 'paragraph', content: '2. 本协议一式两份，甲乙双方各执一份，具有同等法律效力。' },
      { type: 'empty' },
      { type: 'paragraph', content: '甲方（盖章）：{{委托方名称}}', indent: false },
      { type: 'paragraph', content: '乙方（盖章）：{{服务方名称}}', indent: false },
      { type: 'empty' },
      { type: 'paragraph', content: '法定代表人（签字）：            法定代表人（签字）：', indent: false },
      { type: 'empty' },
      { type: 'paragraph', content: '日期：                            日期：', indent: false }
