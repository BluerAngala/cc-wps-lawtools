...
export class ReviewChecklistGenerator {
        ...
        required: [
          {
            ...
            reviewRequirements:
              '审查合同双方主体资格是否合法，包括：1. 企业名称、统一社会信用代码是否完整准确；2. 法定代表人信息是否明确；3. 授权代表是否有有效授权；4. 主体是否具备签约资质',
            riskLevel: 'high',
          ...
          },
          {
            ...
            reviewRequirements:
              '审查服务内容是否明确具体：1. 服务项目、范围是否清晰；2. 服务标准、质量要求是否可量化；3. 服务交付物是否明确；4. 是否存在模糊表述',
            riskLevel: 'high',
          ...
          },
          {
            ...
            reviewRequirements:
              '审查服务标准是否明确：1. 质量标准是否可量化；2. 验收标准是否清晰；3. 不合格服务的处理方式；4. 服务标准变更程序',
            riskLevel: 'high',
            reviewBasis: '《民法典》第五百一十条、第五百一十一条'
          },
          {
            ...
            reviewRequirements:
              '审查合同金额条款：1. 金额是否明确（含税/不含税）；2. 计价方式是否清晰；3. 价格调整机制是否合理；4. 是否存在价格陷阱',
            riskLevel: 'high',
            reviewBasis: '《民法典》第五百一十条、第五百一十一条'
          },
          {
            ...
            reviewRequirements:
              '审查付款条款：1. 付款时间节点是否明确；2. 付款比例是否合理；3. 付款条件是否清晰；4. 逾期付款责任是否明确',
            riskLevel: 'high',
          ...
          },
          {
            ...
            reviewRequirements:
              '审查服务期限：1. 起止时间是否明确；2. 履行期限是否合理；3. 延期条件是否明确；4. 期限变更程序',
            riskLevel: 'high',
            reviewBasis: '《民法典》第五百一十条、第五百一十一条'
          },
          {
            ...
            reviewRequirements:
              '审查验收标准：1. 验收标准是否明确可操作；2. 验收时间是否合理；3. 验收不合格的处理方式；4. 验收争议解决机制',
            riskLevel: 'medium',
            reviewBasis: '《民法典》第五百一十条、第五百一十一条'
          },
          {
            ...
            reviewRequirements:
              '审查违约责任条款：1. 违约情形是否明确；2. 违约金是否过高（超过30%可能被调整）；3. 损失计算方法是否合理；4. 免责条款是否合法',
            riskLevel: 'high',
          ...
          },
          {
            ...
            reviewRequirements:
              '审查争议解决条款：1. 管辖法院是否明确（建议约定被告住所地或合同履行地）；2. 仲裁条款是否有效；3. 争议解决方式是否合理',
            riskLevel: 'high',
          ...
          },
          {
            ...
            keywords: ['合同生效', '生效条件'],
            reviewRequirements:
              '审查合同生效条件：1. 生效条件是否明确；2. 是否需要审批、备案；3. 生效时间是否合理',
            riskLevel: 'medium',
        ...
        optional: [
          {
            ...
            reviewRequirements:
              '审查知识产权条款：1. 知识产权归属是否明确；2. 使用范围是否受限；3. 侵权责任是否明确',
            riskLevel: 'medium',
          ...
          },
          {
            ...
            reviewRequirements:
              '审查保密条款：1. 保密范围是否明确；2. 保密期限是否合理；3. 违约责任是否明确',
            riskLevel: 'medium',
          ...
          },
          {
            ...
            reviewRequirements:
              '审查合同解除条款：1. 解除条件是否明确；2. 解除程序是否合理；3. 解除后的责任承担',
            riskLevel: 'medium',
      ...
      买卖合同: {
        required: [
          ...
          },
          {
            ...
            name: '交付',
            priority: 'high',
            keywords: ['交付', '交货', '交付时间', '交付地点']
          },
          {
            id: 'acceptance',
            name: '验收',
            priority: 'high',
            keywords: ['验收', '验收标准', '验收期限']
          },
          {
            id: 'breach_liability',
            name: '违约责任',
        ...
        optional: [
          {
            ...
            name: '质量保证',
            priority: 'medium',
            keywords: ['质量保证', '保修', '保修期']
          },
          {
            id: 'risk_transfer',
            name: '风险转移',
            priority: 'medium',
            keywords: ['风险', '风险转移', '风险承担']
          }
        ]
      },
        ...
        required: [
          {
            ...
            name: '合同主体信息',
            priority: 'high',
            keywords: ['出租方', '承租方', '甲方', '乙方']
          },
          {
            id: 'rental_object',
            name: '租赁物',
            priority: 'high',
            keywords: ['租赁物', '租赁房屋', '租赁场地']
          },
          {
            id: 'rental_period',
            name: '租赁期限',
            priority: 'high',
            keywords: ['租赁期限', '租期', '租赁时间']
          },
        ...
        required: [
          {
            ...
            name: '当事人信息',
            priority: 'high',
            keywords: ['原告', '被告', '当事人', '身份'],
            reviewRequirements:
              '审查当事人信息是否完整准确：1. 姓名/名称是否正确；2. 身份证号/统一社会信用代码是否完整；3. 住所地/经营地址是否明确；4. 联系方式是否有效',
            riskLevel: 'high',
            reviewBasis: '《民事诉讼法》第一百二十二条'
          },
          {
            id: 'claims',
            name: '诉讼请求',
            ...
            keywords: ['诉讼请求', '请求', '诉请'],
            reviewRequirements:
              '审查诉讼请求是否明确具体：1. 请求事项是否清晰；2. 金额计算是否准确；3. 请求是否有法律依据；4. 请求之间是否存在矛盾',
            riskLevel: 'high',
            reviewBasis: '《民事诉讼法》第一百二十二条'
          },
          {
            ...
            name: '事实与理由',
            priority: 'high',
            keywords: ['事实', '理由', '事实与理由'],
            reviewRequirements:
              '审查事实与理由是否充分：1. 事实陈述是否清晰完整；2. 时间线是否准确；3. 法律依据是否正确；4. 逻辑是否严密',
            riskLevel: 'high',
            reviewBasis: '《民事诉讼法》第一百二十二条'
          },
          {
            ...
            keywords: ['证据', '证据清单', '证明'],
            reviewRequirements:
              '审查证据是否充分：1. 证据是否与诉请相关；2. 证据来源是否合法；3. 证据是否完整；4. 证据证明力如何',
            riskLevel: 'high',
            reviewBasis: '《民事诉讼法》第六十六条'
          },
          {
            id: 'jurisdiction',
            name: '管辖权',
            ...
            keywords: ['管辖', '法院', '管辖权'],
            reviewRequirements:
              '审查管辖是否正确：1. 级别管辖是否正确；2. 地域管辖是否正确；3. 是否存在管辖约定；4. 是否存在专属管辖',
            riskLevel: 'high',
            reviewBasis: '《民事诉讼法》第二十四条至第三十五条'
          },
          {
            ...
            keywords: ['时效', '诉讼时效', '期限'],
            reviewRequirements:
              '审查诉讼时效：1. 是否在诉讼时效期间内；2. 是否存在时效中断/中止情形；3. 时效起算点是否正确',
            riskLevel: 'high',
            reviewBasis: '《民法典》第一百八十八条至第一百九十九条'
          }
        ],
        optional: [
          {
            ...
            name: '保全申请',
            priority: 'medium',
            keywords: ['保全', '财产保全', '行为保全'],
            reviewRequirements:
              '审查是否需要申请保全：1. 是否有保全必要；2. 保全范围是否适当；3. 担保是否充分',
            riskLevel: 'medium',
            reviewBasis: '《民事诉讼法》第一百零三条'
          },
          {
            id: 'legal_basis',
            name: '法律依据',
            ...
            keywords: ['法律依据', '法条', '规定'],
            reviewRequirements:
              '审查法律依据是否准确：1. 引用法条是否正确；2. 法条是否现行有效；3. 适用是否恰当',
            riskLevel: 'medium',
            reviewBasis: '相关实体法规定'
          }
        ]
        ...
        required: [
          {
            ...
            name: '发函方信息',
            priority: 'high',
            keywords: ['委托人', '发函方', '律师事务所'],
            reviewRequirements:
              '审查发函方信息：1. 委托人信息是否完整；2. 律师事务所信息是否准确；3. 授权是否有效',
            riskLevel: 'high',
            reviewBasis: '《律师法》相关规定'
          },
          {
            id: 'recipient_info',
            name: '收函方信息',
            ...
            keywords: ['收函方', '被告知方'],
            reviewRequirements:
              '审查收函方信息：1. 名称/姓名是否正确；2. 地址是否准确；3. 主体是否适格',
            riskLevel: 'high',
            reviewBasis: '相关规定'
          },
          {
            ...
            keywords: ['事实', '经过', '情况'],
            reviewRequirements:
              '审查事实陈述：1. 事实是否客观准确；2. 表述是否清晰；3. 是否有证据支持；4. 是否存在诽谤风险',
            riskLevel: 'high',
            reviewBasis: '《民法典》相关规定'
          },
          {
            id: 'demands',
            name: '要求事项',
            ...
            keywords: ['要求', '请求', '敦促'],
            reviewRequirements:
              '审查要求事项：1. 要求是否明确具体；2. 要求是否有法律依据；3. 期限是否合理；4. 后果告知是否适当',
            riskLevel: 'high',
            reviewBasis: '相关实体法规定'
          },
          {
            ...
            keywords: ['后果', '法律后果', '责任'],
            reviewRequirements:
              '审查法律后果告知：1. 后果告知是否准确；2. 是否存在威胁恐吓；3. 表述是否得当',
            riskLevel: 'medium',
            reviewBasis: '相关规定'
          }
        ],
        optional: [
          {
            ...
            priority: 'medium',
            keywords: ['期限', '回复', '答复'],
            reviewRequirements: '审查回复期限：1. 期限是否合理；2. 起算点是否明确',
            riskLevel: 'low',
            reviewBasis: '相关规定'
          }
        ]
        ...
        required: [
          {
            ...
            keywords: ['背景', '概况', '基本情况'],
            reviewRequirements:
              '审查背景介绍：1. 背景描述是否完整；2. 关键信息是否准确；3. 是否遗漏重要事实',
            riskLevel: 'medium',
            reviewBasis: '相关规定'
          },
          {
            ...
            keywords: ['分析', '法律分析', '论证'],
            reviewRequirements:
              '审查法律分析：1. 分析是否全面；2. 逻辑是否严密；3. 法律依据是否准确；4. 结论是否有支撑',
            riskLevel: 'high',
            reviewBasis: '相关实体法规定'
          },
          {
            ...
            keywords: ['结论', '意见', '建议'],
            reviewRequirements:
              '审查结论意见：1. 结论是否明确；2. 是否与分析一致；3. 建议是否可行；4. 风险提示是否充分',
            riskLevel: 'high',
            reviewBasis: '相关规定'
          },
          {
            ...
            keywords: ['风险', '提示', '注意'],
            reviewRequirements:
              '审查风险提示：1. 风险识别是否全面；2. 风险等级是否准确；3. 应对建议是否合理',
            riskLevel: 'high',
            reviewBasis: '相关规定'
          }
        ],
        optional: [
          {
            ...
            priority: 'medium',
            keywords: ['假设', '前提', '条件'],
            reviewRequirements: '审查假设前提：1. 假设是否合理；2. 是否明确告知客户',
            riskLevel: 'medium',
            reviewBasis: '相关规定'
          },
          {
            ...
            priority: 'medium',
            keywords: ['限制', '范围', '声明'],
            reviewRequirements: '审查意见限制：1. 限制范围是否明确；2. 免责声明是否充分',
            riskLevel: 'medium',
            reviewBasis: '相关规定'
          }
        ]
        ...
        required: [
          {
            ...
            name: '协议各方',
            priority: 'high',
            keywords: ['甲方', '乙方', '各方', '当事人'],
            reviewRequirements:
              '审查协议各方信息：1. 主体信息是否完整；2. 签约资格是否具备；3. 授权是否有效',
            riskLevel: 'high',
            reviewBasis: '《民法典》第四百六十九条'
          },
          {
            id: 'subject_matter',
            name: '协议事项',
            priority: 'high',
            keywords: ['事项', '内容', '标的'],
            reviewRequirements: '审查协议事项：1. 事项是否明确；2. 范围是否清晰；3. 是否存在歧义',
            riskLevel: 'high',
            reviewBasis: '《民法典》第四百七十条'
          },
          {
            ...
            keywords: ['权利', '义务', '责任'],
            reviewRequirements:
              '审查权利义务：1. 权利义务是否对等；2. 是否存在显失公平；3. 是否有遗漏',
            riskLevel: 'high',
            reviewBasis: '《民法典》第五百零九条'
          },
          {
            id: 'breach_liability',
            name: '违约责任',
            ...
            reviewRequirements:
              '审查违约责任：1. 违约情形是否明确；2. 违约金是否合理；3. 救济方式是否充分',
            riskLevel: 'high',
            reviewBasis: '《民法典》第五百七十七条'
          },
          {
            id: 'dispute_resolution',
            name: '争议解决',
            priority: 'high',
            keywords: ['争议', '纠纷', '解决'],
            reviewRequirements: '审查争议解决：1. 解决方式是否明确；2. 管辖约定是否有效',
            riskLevel: 'high',
            reviewBasis: '《民事诉讼法》第三十五条'
          }
        ],
        optional: [
          {
            ...
            priority: 'medium',
            keywords: ['保密', '秘密'],
            reviewRequirements: '审查保密条款：1. 保密范围是否明确；2. 保密期限是否合理',
            riskLevel: 'medium',
            reviewBasis: '《民法典》第五百零一条'
          },
          {
            id: 'termination',
            name: '终止条款',
            priority: 'medium',
            keywords: ['终止', '解除'],
            reviewRequirements: '审查终止条款：1. 终止条件是否明确；2. 终止后果是否清晰',
            riskLevel: 'medium',
            reviewBasis: '《民法典》第五百六十二条'
          }
        ]
      },
        ...
        required: [
          {
            ...
            name: '文书主体',
            priority: 'high',
            keywords: ['甲方', '乙方', '当事人', '主体'],
            reviewRequirements: '审查文书主体信息是否完整准确',
            riskLevel: 'high',
            reviewBasis: '相关法律规定'
          },
          {
            ...
            priority: 'high',
            keywords: ['内容', '事项', '标的'],
            reviewRequirements: '审查核心内容是否明确清晰',
            riskLevel: 'high',
            reviewBasis: '相关法律规定'
          },
          {
            ...
            priority: 'high',
            keywords: ['权利', '义务', '责任'],
            reviewRequirements: '审查权利义务是否明确、对等',
            riskLevel: 'high',
            reviewBasis: '相关法律规定'
          },
          {
            ...
            priority: 'medium',
            keywords: ['法律', '依据', '规定'],
            reviewRequirements: '审查法律依据是否正确有效',
            riskLevel: 'medium',
            reviewBasis: '相关法律规定'
          },
          {
            ...
            priority: 'high',
            keywords: ['风险', '问题', '隐患'],
            reviewRequirements: '识别潜在法律风险和问题',
            riskLevel: 'high',
            reviewBasis: '相关法律规定'
          }
        ],
  ...
  generateChecklist(documentType, perspective = 'neutral') {
    ...
    console.log(
      `[审查清单] 文档类型: ${type}, 视角: ${isCustomPerspective ? '自定义' : perspective}, 生成清单 ${checklist.length} 项`
    )
  ...
  mergeUserRules(baseChecklist, userRules) {
    ...
    console.log(
      `[审查清单] 合并用户规则: 基础 ${baseChecklist.length} 项 + 用户 ${userRules.length} 项 = 总计 ${mergedChecklist.length} 项`
    )
