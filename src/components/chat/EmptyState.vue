...
.empty-state {
  ...
  justify-content: center; padding: 40px 10px;
}
.empty-logo {
  width: 56px; height: 56px; background: #f5f5f5; border-radius: 14px;
  display: flex; align-items: center; justify-content: center;
  color: var(--c-highlight); margin-bottom: 16px;
  box-shadow: 0 4px 20px rgba(0,0,0,0.15);
}
.empty-title { font-size: 18px; font-weight: 800; margin: 0 0 6px; color: var(--c-brand); }
.empty-desc { font-size: 13px; color: var(--c-text2); margin: 0 0 24px; }
.quick-grid {
...
.quick-card {
  ...
  padding: 10px 10px; border: 1px solid var(--c-border);
  border-radius: var(--radius-sm, 8px); background: var(--c-surface);
